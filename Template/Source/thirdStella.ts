namespace Template {
  export async function thirdStella(): ƒS.SceneReturn {
    ...
    await ƒS.Speech.tell(characters.stella, "Ich wollte nur vorbei kommen, um mich für den Tipp zu bedanken. Ich denke in drei Tagen Tagen komm ich wieder, ich muss nur noch etwas davor in Ordnung bringen");
