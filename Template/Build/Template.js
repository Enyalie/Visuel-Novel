...
(function (Template) {
    async function firstStella() {
        ...
        await Template.ƒS.Speech.tell(Template.characters.narrator, "Dies ist eine Geschichte, über einen mürrischen Kriger");
        await Template.ƒS.Speech.tell(Template.characters.narrator, "einer vermumten Doktorin");
